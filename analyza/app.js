...
// TELEFÓN — kontrola tvaru presťahovaná do /shared/phone.js (27. 8. 2026),
// aby ju kvíz aj analýza mali naozaj rovnakú. Obe stránky píšu do toho istého
// stĺpca `quiz_calls.phone`; dve kópie funkcie by sa skôr či neskôr rozišli.
// `normalizePhone()` a `PHONE_ERR` sem prináša `<script>` v index.html.
